class Togue {
  constructor() {
    ...
    this.mapGenerated = new Array(10)
      .fill(17)
      .map(() => new Array(10).fill(17));
  ...
  setup() {
    ...
    this.t = new Tileset(
      loadImage("assets/colored_tilemap_packed.png"),
      8,
      16,
      10,
      10
  ...
  keyTyped() {
    if (key === "a") this.showFullTileset = !this.showFullTileset;
    else if (key === "s")
  ...
  draw() {
    background(0);
    if (mouseIsPressed && !this.showFullTileset) this.updateMap();
